 ...
 */
double KMagnetostaticAnalyticLineSegmentIntegrator::Potential(const KLineSegment* source, const KPosition& P) const
{
...
KFieldVector KMagnetostaticAnalyticLineSegmentIntegrator::MagneticField(const KLineSegment* source,
